...
include_once '../../models/Agents/AgentModifFormType.php';
...
<div class="container">
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                ...
                <div class="col-12 col-md-auto text-center">
                    <div class="col"><a href="../agents/agentsView.php" class="btn btn-warning">Revenir à la liste</a></div>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <form action="../agents/agentsValideModifView.php" method="post">
