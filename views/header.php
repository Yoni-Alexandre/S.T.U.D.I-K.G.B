...
<header>
    <nav class="navbar navbar-expand-lg bg-studi-kgb">
        <div class="container-fluid">
            <a class="navbar-brand title-studi-kgb" href="../index.php">S.T.U.D.I | K.G.B</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active title-studi-kgb" aria-current="page" href="../index.php?uc=administration&action=login">Administration</a>
                    </li>
