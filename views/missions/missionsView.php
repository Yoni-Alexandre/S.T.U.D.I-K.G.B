...
include_once '../../models/Missions/Mission.php';
    ...
    <div class="row pt-3">
        ...
        <div class="col-3">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mt-4 mb-3 border-bottom">
                <a href="../../form/missionFormType.php" class="btn btn-success"><i class="fas fa-plus-circle"></i>  Ajouter une mission</a>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <table class="table table-hover table-striped mt-5 text-center">
                ...
                <?php foreach ($missions as $mission) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="MissionViewDetail.php?id=<?php echo $mission->id ?>" class="btn btn-primary"><i class="fas fa-pen"></i></a>
                            <a type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#missionSupprModal" data-suppression="missionSuppr.php?id=<?php echo $mission->id ?>"><i class="fas fa-trash"></i></a>
                        </td>
